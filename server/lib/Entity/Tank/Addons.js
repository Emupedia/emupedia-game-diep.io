...
class Addon {
    ...
    createAutoTurrets(count) {
        ...
        const MAX_ANGLE_RANGE = util_1.PI2 / 4; // keep within 90º each side
        ...
        for (let i = 0; i < count; ++i) {
            ...
            base.ai.targetFilter = (targetPos) => {
                ...
                const deltaAngle = (0, util_1.normalizeAngle)(angleToTarget - ((angle + rotator.position.values.angle)));
