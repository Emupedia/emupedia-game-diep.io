...
class Teams2Arena extends Arena_1.default {
    constructor(game) {
        ...
        this.blueTeamBase = new TeamBase_1.default(game, new TeamEntity_1.TeamEntity(this.game, Enums_1.Colors.TeamBlue), -arenaSize + baseWidth / 2, 0, arenaSize * 2, baseWidth);
        this.redTeamBase = new TeamBase_1.default(game, new TeamEntity_1.TeamEntity(this.game, Enums_1.Colors.TeamRed), arenaSize - baseWidth / 2, 0, arenaSize * 2, baseWidth);
    }
